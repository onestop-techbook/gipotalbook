...
いっときHTTPSの設定がグレーアウトしていることがあったなど、タイミングなのか、何かに関連するものがあるのかはよくわかりませんが、設定できなくなることがありました。httpでは見れるけれどhttpsでは見れないといった状態が起こりえます。
...
![正式名称の決定](chap-mob-0614/namevoting.png?scale=0.5)
...
![ぎぽたる族のキャラ設定](chap-mob-0614/charasetting.png?scale=0.8)
