...
あとは、Hasuraの画面からテストデータを作ります。Add new tableから模擬データを作ります。この辺りは、過去のモブでやったところですね。ところでここで、データタイプの型にName型というのがあることに気づき、なんじゃこりゃ、という感想も出ます。まあテキストでいいですよね。となり、シンプルにテキストで進めます。
...
これでは他に使ってみようと思った人が困ってしまいます。そこで、`.env.exaple`を作り、公開しておくとともにセットアップ方法をReadmeに記載します。初めてリポジトリを見た人にもわかるようにしておきます。
