...
//embed{
    ...
    \hspace{1ex}
//}
ウェブフロントエンドを中心にユーザーが触れる部分を作っています。4年ほどリモート中心で働いていたら、いきなりリモートワークが推奨される社会になってびっくりしています。
...
ギポタル的にはモブにはたまに参加してる程度なので、本の調整したり…のほうが比重強めですね。
...
//embed{
    ...
    \hspace{1ex}
//}
突如現れた米類のテックリード。ウェブフロントエンドが得意ですが、GCPやGoとかもやってます。
