...
この本は２０２０年６月頃に始まった「技術同人誌ポータル　ギポタル（以下、ギポタルと記載）」の開発過程を追う本です。この本の目的は次に示すようにいくつかありますが、いずれも開発者一同及びこの本を手に取っていただいた皆様に役に立つことを信じています。

//blankline
@<b>{ギポタルを紹介、周知するため}

このサービスの開発過程をご紹介することで、よりたくさんの人にギポタルを知って、使って欲しいと思っています。サークル主にとっては、サークルのポータルとして。またここを経由してご自分の本の売り上げがUPすることを期待しています。
...
最後に、この本ができあがるがるころには、サービスがリリースされているはずですが、まだまだあったらいいなの機能や働きがあるでしょう。登録サークル数が増え、訪れる人が増えることでさらに進化していきます。サークル登録する、口コミで広げる、実際に使う、いずれもとてもありがたい貢献、参加の形です。要望を出す、開発チームに参加する、ぜひお願いします。
