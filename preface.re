...
先ごろ始まった「技術同人誌ポータル　ぎぽたる」の開発過程を追う本です。この本の目的は次に示すようにいくつかありますが、いずれも開発者一同及びこの本を手に取っていただいた皆様に役に立つことを信じています。
...
今回のサービスは、あったらいいなから始まっています。類似のサービスにあること、既存サービスでは足りないこと、そもそも何のためのサービスかといったコンセプトを決めるところから事務局一同で作り上げてきました。
...
もちろんその技術やステップに必要なこと全てを解説することはできませんが、開発の一つのルートとして、マイルストーンをできるだけ配置するようにしています。これが最善であるという保証はありません。またそれぞれの技術についても複数の参考書、書籍、様々な媒体で参考事例や解説があるような広大かつ深淵なものですから、この本に取り上げることができた内容なそのごく一部にすぎません。ですがそれぞれのステップにおいて、必要な本当の最低限を知ることで、それをベンチマークとしてさらにスマートに開発を進めることができる場面があるのではないかと考えます。

　

さて、本稿執筆者の皆様、そしてぎぽたる開発チームの皆様、本当にありがとうございます。思いつきから始まったこのプロジェクトですが、サービスのリリースと本の発行を経て、一区切りとなります。当然一人では単なる夢物語に過ぎませんでしたが、全員が参加することで形になりました。

最後に、この本ができあがるがるころには、リリースされているはずですが、まだまだあったらいいなな機能や働きがあるでしょう。登録サークル数が増え、訪れる人が増えることでさらに進化していきます。サークル登録する、口コミで広げる、実際に使う、いずれもとてもありがたいContributeです。要望を出す、開発チームに参加する、ぜひお願いします。
